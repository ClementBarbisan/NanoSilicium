...
public class IntestinsController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        cross = false;
        transform.rotation = Quaternion.Lerp(transform.rotation, Quaternion.LookRotation(arrival - transform.position, Vector3.up) * Quaternion.Euler(90, 0, 0), 0.1f);
